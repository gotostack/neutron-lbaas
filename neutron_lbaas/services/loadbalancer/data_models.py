...
class Rule(BaseDataModel):
    ...
    def to_api_dict(self):
        ret_dict = super(Rule, self).to_dict(
...
class Listener(BaseDataModel):
    ...
    def to_api_dict(self):
        ...
        ret_dict['rules'] = [r.id for r in self.rules]
        return ret_dict
    ...
    def from_dict(cls, model_dict):
        ...
        model_dict['rules'] = [Rule.from_dict(r)
                               for r in rules]
        if default_pool:
